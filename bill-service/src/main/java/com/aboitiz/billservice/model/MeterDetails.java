...
@NamedQueries({
    @NamedQuery(name = "MeterDetails.findAll", query = "SELECT m FROM MeterDetails m")})
public class MeterDetails implements Serializable {
    ...
    public boolean equals(Object object) {
        ...
        if ((this.meterDetailsPK == null && other.meterDetailsPK != null) || (this.meterDetailsPK != null && !this.meterDetailsPK.equals(other.meterDetailsPK))) {
            return false;
        }
        return true;
    }
