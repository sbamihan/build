...
Procedures:
1.	Reacts to `BILL-STAGED` event published in the event store [**Bill Stager**](https://github.com/sbamihan/build/tree/master/eBill/bill-stager).
2.	Gets bill information from persistence store based on data published on `BILL-STAGED` topic in the event store.
